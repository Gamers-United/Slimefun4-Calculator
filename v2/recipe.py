...
class Recipe:
    ...
    def __str__(self):
        ...
        return f"(Inputs: {input_string}, Output: {output_string}, Process Host: {self.process_host}, Qty: {self.output_qty}, Shaped: {self.is_shaped}, Shaped Recipe: {self.resolveShapedRecipe()})"